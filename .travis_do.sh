...
download_sdk() {
	...
	echo "=== download SDK"
	wget https://downloads.lede-project.org/snapshots/targets/ar71xx/generic/sha256sums -O sha256sums
	wget https://downloads.lede-project.org/snapshots/targets/ar71xx/generic/sha256sums.gpg -O sha256sums.asc
	...
	if ! sha256sum -c ./sha256sums.small ; then
		wget https://downloads.lede-project.org/snapshots/targets/ar71xx/generic/$SDK.tar.xz -O $SDK.tar.xz
	fi
